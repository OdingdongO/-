...
rawdata_root = 'D://EXPERIMENT/2/datasets/'
all_pd = pd.read_csv("D://EXPERIMENT/2/datasets/train.txt",sep=" ",
...
true_test_pb = pd.read_csv("D://EXPERIMENT/2/datasets/test.txt",sep=" ",
...
resume = 'D://EXPERIMENT/2/baidu_model/multiscale_resnet/weights-19-266-[0.9535].pth'
